...
pub const ImGuiKey = enum(c_int) {
    ...
    _GamepadBack = 618,
    _GamepadFaceUp = 619,
    _GamepadFaceDown = 620,
    _GamepadFaceLeft = 621,
    _GamepadFaceRight = 622,
    _GamepadDpadUp = 623,
    _GamepadDpadDown = 624,
    _GamepadDpadLeft = 625,
    _GamepadDpadRight = 626,
    _GamepadL1 = 627,
    _GamepadR1 = 628,
    _GamepadL2 = 629,
    _GamepadR2 = 630,
    _GamepadL3 = 631,
    _GamepadR3 = 632,
    _GamepadLStickUp = 633,
    _GamepadLStickDown = 634,
    _GamepadLStickLeft = 635,
    _GamepadLStickRight = 636,
    _GamepadRStickUp = 637,
    _GamepadRStickDown = 638,
    _GamepadRStickLeft = 639,
    _GamepadRStickRight = 640,
    _ModCtrl = 641,
    _ModShift = 642,
    _ModAlt = 643,
    _ModSuper = 644,
...
pub fn ImageButton(user_texture_id: ImTextureID, size: ImVec2, __default: struct{uv0: ImVec2= .{.x=0, .y=0}, uv1: ImVec2= ImVec2(1,1), frame_padding: c_int= -1, bg_col: ImVec4= ImVec4(0,0,0,0), tint_col: ImVec4= ImVec4(1,1,1,1)}) bool
{
...
pub const ImGuiItemFlags = enum(c_int) {
    _None = 0,
    _NoTabStop = 1,
    _ButtonRepeat = 2,
    _Disabled = 4,
    _NoNav = 8,
    _NoNavDefaultFocus = 16,
    _SelectableDontClosePopup = 32,
    _MixedValue = 64,
    _ReadOnly = 128,
    _Inputable = 256,
};

pub const ImGuiItemStatusFlags = enum(c_int) {
    _None = 0,
    _HoveredRect = 1,
    _HasDisplayRect = 2,
    _Edited = 4,
...
pub const ImGuiComboFlagsPrivate = enum(c_int) {
    ImGuiComboFlags_CustomPreview = 1048576,
};

pub const ImGuiSliderFlagsPrivate = enum(c_int) {
    ImGuiSliderFlags_Vertical = 1048576,
    ImGuiSliderFlags_ReadOnly = 2097152,
};

pub const ImGuiSelectableFlagsPrivate = enum(c_int) {
...
pub const ImGuiTreeNodeFlagsPrivate = enum(c_int) {
    ImGuiTreeNodeFlags_ClipLabelForTrailingButton = 1048576,
};

pub const ImGuiSeparatorFlags = enum(c_int) {
    _None = 0,
    _Horizontal = 1,
    _Vertical = 2,
    _SpanAllColumns = 4,
...
pub const ImGuiTextFlags = enum(c_int) {
    _None = 0,
    _NoWidthForLargeClippedText = 1,
};

pub const ImGuiTooltipFlags = enum(c_int) {
    _None = 0,
    _OverridePreviousTooltip = 1,
};

pub const ImGuiLayoutType = enum(c_int) {
    _Horizontal = 0,
    _Vertical = 1,
};
...
pub const ImGuiDataTypePrivate = enum(c_int) {
    ImGuiDataType_String = 11,
    ImGuiDataType_Pointer = 12,
    ImGuiDataType_ID = 13,
};

pub const ImGuiNextWindowDataFlags = enum(c_int) {
    _None = 0,
    _HasPos = 1,
    _HasSize = 2,
    _HasContentSize = 4,
    _HasCollapsed = 8,
    _HasSizeConstraint = 16,
    _HasFocus = 32,
    _HasBgAlpha = 64,
    _HasScroll = 128,
    _HasViewport = 256,
    _HasDock = 512,
    _HasWindowClass = 1024,
};

pub const ImGuiNextItemDataFlags = enum(c_int) {
    _None = 0,
    _HasWidth = 1,
    _HasOpen = 2,
};

pub const ImGuiKeyPrivate = enum(c_int) {
...
pub const ImGuiInputEventType = enum(c_int) {
    _None = 0,
    _MousePos = 1,
    _MouseWheel = 2,
    _MouseButton = 3,
...
pub const ImGuiNavReadMode = enum(c_int) {
    _Down = 0,
    _Pressed = 1,
    _Released = 2,
    _Repeat = 3,
...
pub const ImGuiActivateFlags = enum(c_int) {
    _None = 0,
    _PreferInput = 1,
    _PreferTweak = 2,
    _TryToPreserveState = 4,
};

pub const ImGuiScrollFlags = enum(c_int) {
    _None = 0,
    _KeepVisibleEdgeX = 1,
    _KeepVisibleEdgeY = 2,
    _KeepVisibleCenterX = 4,
    _KeepVisibleCenterY = 8,
    _AlwaysCenterX = 16,
    _AlwaysCenterY = 32,
    _NoScrollParent = 64,
    _MaskX_ = 21,
...
pub const ImGuiNavHighlightFlags = enum(c_int) {
    _None = 0,
    _TypeDefault = 1,
    _TypeThin = 2,
    _AlwaysDraw = 4,
...
pub const ImGuiNavDirSourceFlags = enum(c_int) {
    _None = 0,
    _RawKeyboard = 1,
    _Keyboard = 2,
    _PadDPad = 4,
...
pub const ImGuiNavMoveFlags = enum(c_int) {
    _None = 0,
    _LoopX = 1,
    _LoopY = 2,
    _WrapX = 4,
    _WrapY = 8,
    _AllowCurrentNavId = 16,
    _AlsoScoreVisibleSet = 32,
    _ScrollToEdgeY = 64,
    _Forwarded = 128,
    _DebugNoResult = 256,
    _FocusApi = 512,
...
pub const ImGuiOldColumnFlags = enum(c_int) {
    _None = 0,
    _NoBorder = 1,
    _NoResize = 2,
    _NoPreserveWidths = 4,
    _NoForceWithinWindow = 8,
    _GrowParentContentsSize = 16,
...
pub const ImGuiDockNodeFlagsPrivate = enum(c_int) {
...
pub const ImGuiDataAuthority = enum(c_int) {
    _Auto = 0,
    _DockNode = 1,
    _Window = 2,
};
...
pub const ImGuiDebugLogFlags = enum(c_int) {
    _None = 0,
    _EventActiveId = 1,
    _EventFocus = 2,
    _EventPopup = 4,
...
pub const ImGuiDockRequest = opaque {};
pub const ImGuiDockNodeSettings = opaque {};
pub const ImGuiTableColumnsSettings = opaque {};
const ImGuiErrorLogCallback = fn (user_data: ?*anyopaque, fmt: ?[*:0]const u8) callconv(.C) void;
...
test "sizeof ImVec1" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImVec1) == 4);
}

pub const ImVec2ih = extern struct {
    x: c_short,
    y: c_short,
};

test "sizeof ImVec2ih" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImVec2ih) == 4);
}

pub const ImRect = extern struct {
    Min: ImVec2,
    Max: ImVec2,
};
...
test "sizeof ImRect" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImRect) == 16);
}

pub const ImBitVector = extern struct {
    Storage: ImVector,
};

pub const ImDrawListSharedData = extern struct {
    TexUvWhitePixel: ImVec2,
    Font: ?*ImFont,
    FontSize: f32,
    CurveTessellationTol: f32,
...
test "sizeof ImDrawListSharedData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImDrawListSharedData) == 512);
}

pub const ImDrawDataBuilder = extern struct {
    Layers: ImVector,
};

pub const ImGuiDataTypeTempStorage = extern struct {
    Data: [8]u8,
};

test "sizeof ImGuiDataTypeTempStorage" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiDataTypeTempStorage) == 8);
}

pub const ImGuiDataTypeInfo = extern struct {
    Size: usize,
    Name: ?[*:0]const u8,
    PrintFmt: ?[*:0]const u8,
    ScanFmt: ?[*:0]const u8,
...
test "sizeof ImGuiDataTypeInfo" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiDataTypeInfo) == 32);
}

pub const ImGuiColorMod = extern struct {
    Col: c_int,
    BackupValue: ImVec4,
};

test "sizeof ImGuiColorMod" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiColorMod) == 20);
}

pub const ImGuiStyleMod = extern struct {
    VarIdx: c_int,
};

test "sizeof ImGuiStyleMod" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiStyleMod) == 12);
}

pub const ImGuiComboPreviewData = extern struct {
    PreviewRect: ImRect,
...
test "sizeof ImGuiComboPreviewData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiComboPreviewData) == 48);
}

pub const ImGuiGroupData = extern struct {
    WindowID: c_uint,
    BackupCursorPos: ImVec2,
    BackupCursorMaxPos: ImVec2,
    BackupIndent: ImVec1,
    ...
    BackupActiveIdIsAlive: c_uint,
    BackupActiveIdPreviousFrameIsAlive: bool,
    BackupHoveredIdIsAlive: bool,
    EmitItem: bool,
};

test "sizeof ImGuiGroupData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiGroupData) == 48);
}

pub const ImGuiMenuColumns = extern struct {
    TotalWidth: c_uint,
    NextTotalWidth: c_uint,
    Spacing: c_ushort,
    OffsetIcon: c_ushort,
    OffsetLabel: c_ushort,
    OffsetShortcut: c_ushort,
    OffsetMark: c_ushort,
    Widths: [4]c_ushort,
};

test "sizeof ImGuiMenuColumns" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiMenuColumns) == 28);
}

pub const ImGuiInputTextState = extern struct {
    ID: c_uint,
    CurLenW: c_int,
    CurLenA: c_int,
    TextW: ImVector,
    TextA: ImVector,
    InitialTextA: ImVector,
    TextAIsValid: bool,
    BufCapacityA: c_int,
    ScrollX: f32,
...
pub const ImGuiPopupData = extern struct {
    PopupId: c_uint,
    Window: ?*ImGuiWindow,
...
test "sizeof ImGuiPopupData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiPopupData) == 56);
}

pub const ImGuiNextWindowData = extern struct {
    Flags: c_int,
    PosCond: c_int,
    SizeCond: c_int,
    CollapsedCond: c_int,
    ...
    SizeCallback: *const ImGuiSizeCallback,
...
test "sizeof ImGuiNextWindowData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiNextWindowData) == 144);
}

pub const ImGuiNextItemData = extern struct {
    Flags: c_int,
    Width: f32,
    FocusScopeId: c_uint,
    OpenCond: c_int,
...
test "sizeof ImGuiNextItemData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiNextItemData) == 20);
}

pub const ImGuiLastItemData = extern struct {
    ID: c_uint,
    InFlags: c_int,
    StatusFlags: c_int,
    Rect: ImRect,
...
test "sizeof ImGuiLastItemData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiLastItemData) == 60);
}

pub const ImGuiStackSizes = extern struct {
...
test "sizeof ImGuiStackSizes" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiStackSizes) == 18);
}

pub const ImGuiWindowStackData = extern struct {
    Window: ?*ImGuiWindow,
    ParentLastItemDataBackup: ImGuiLastItemData,
    StackSizesOnBegin: ImGuiStackSizes,
};

test "sizeof ImGuiWindowStackData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiWindowStackData) == 88);
}

pub const ImGuiShrinkWidthItem = extern struct {
    Index: c_int,
    Width: f32,
    InitialWidth: f32,
};

test "sizeof ImGuiShrinkWidthItem" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiShrinkWidthItem) == 12);
}

pub const ImGuiPtrOrIndex = extern struct {
    Ptr: ?*anyopaque,
    Index: c_int,
};

test "sizeof ImGuiPtrOrIndex" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiPtrOrIndex) == 16);
}

pub const ImGuiInputEventMousePos = extern struct {
    PosX: f32,
    PosY: f32,
};

test "sizeof ImGuiInputEventMousePos" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventMousePos) == 8);
}

pub const ImGuiInputEventMouseWheel = extern struct {
    WheelX: f32,
    WheelY: f32,
};

test "sizeof ImGuiInputEventMouseWheel" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventMouseWheel) == 8);
}

pub const ImGuiInputEventMouseButton = extern struct {
    Button: c_int,
    Down: bool,
};

test "sizeof ImGuiInputEventMouseButton" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventMouseButton) == 8);
}

pub const ImGuiInputEventMouseViewport = extern struct {
    HoveredViewportID: c_uint,
};

test "sizeof ImGuiInputEventMouseViewport" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventMouseViewport) == 4);
}

pub const ImGuiInputEventKey = extern struct {
    Key: c_int,
    Down: bool,
    AnalogValue: f32,
};

test "sizeof ImGuiInputEventKey" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventKey) == 12);
}

pub const ImGuiInputEventText = extern struct {
    Char: c_uint,
};

test "sizeof ImGuiInputEventText" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEventText) == 4);
}

pub const ImGuiInputEventAppFocused = extern struct {
    Focused: bool,
};

pub const ImGuiInputEvent = extern struct {
    Type: ImGuiInputEventType,
    Source: ImGuiInputSource,
    AddedByTestEngine: bool,
};

test "sizeof ImGuiInputEvent" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiInputEvent) == 24);
}

pub const ImGuiListClipperRange = extern struct {
    Min: c_int,
    Max: c_int,
...
test "sizeof ImGuiListClipperRange" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiListClipperRange) == 12);
}

pub const ImGuiListClipperData = extern struct {
...
pub const ImGuiNavItemData = extern struct {
    Window: ?*ImGuiWindow,
    ID: c_uint,
    FocusScopeId: c_uint,
    RectRel: ImRect,
...
test "sizeof ImGuiNavItemData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiNavItemData) == 48);
}

pub const ImGuiOldColumnData = extern struct {
    OffsetNorm: f32,
...
test "sizeof ImGuiOldColumnData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiOldColumnData) == 28);
}

pub const ImGuiOldColumns = extern struct {
    ID: c_uint,
    Flags: c_int,
    IsFirstFrame: bool,
    IsBeingResized: bool,
...
pub const ImGuiDockNode = packed struct {
    ID: c_uint,
    SharedFlags: c_int,
    LocalFlags: c_int,
    ...
    CountNodeWithWindows: c_int,
    LastFrameAlive: c_int,
    LastFrameActive: c_int,
    LastFrameFocused: c_int,
    LastFocusedNodeId: c_uint,
    SelectedTabId: c_uint,
    WantCloseTabId: c_uint,
    AuthorityForPos: u3,
    AuthorityForSize: u3,
    AuthorityForViewport: u3,
    IsVisible: u1,
    IsFocused: u1,
    IsBgDrawnThisFrame: u1,
    HasCloseButton: u1,
    HasWindowMenuButton: u1,
    HasCentralNodeChild: u1,
    WantCloseAll: u1,
    WantLockSizeOnce: u1,
    WantMouseMove: u1,
    WantHiddenTabBarUpdate: u1,
    WantHiddenTabBarToggle: u1,
};

pub const ImGuiWindowDockStyle = extern struct {
    Colors: [6]c_uint,
};

test "sizeof ImGuiWindowDockStyle" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiWindowDockStyle) == 24);
}

pub const ImGuiDockContext = extern struct {
    Nodes: ImGuiStorage,
    Requests: ImVector,
    NodesSettings: ImVector,
    WantFullRebuild: bool,
};

pub const ImGuiViewportP = extern struct {
    Idx: c_int,
    LastFrameActive: c_int,
...
pub const ImGuiWindowSettings = extern struct {
    ID: c_uint,
    Pos: ImVec2ih,
    Size: ImVec2ih,
...
test "sizeof ImGuiWindowSettings" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiWindowSettings) == 32);
}

pub const ImGuiSettingsHandler = extern struct {
    TypeName: ?[*:0]const u8,
    TypeHash: c_uint,
    ClearAllFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler) void,
    ReadInitFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler) void,
    ReadOpenFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler, name: ?[*:0]const u8) ?*anyopaque,
    ReadLineFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler, entry: ?*anyopaque, line: ?[*:0]const u8) void,
    ApplyAllFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler) void,
    WriteAllFn: ?*const fn (ctx: ?*ImGuiContext, handler: ?*ImGuiSettingsHandler, out_buf: ?*ImGuiTextBuffer) void,
    UserData: ?*anyopaque,
};

test "sizeof ImGuiSettingsHandler" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiSettingsHandler) == 72);
}

pub const ImGuiMetricsConfig = extern struct {
    ShowDebugLog: bool,
    ShowStackTool: bool,
...
test "sizeof ImGuiMetricsConfig" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiMetricsConfig) == 16);
}

pub const ImGuiStackLevelInfo = packed struct {
    ID: c_uint,
    QueryFrameCount: i8,
    QuerySuccess: bool,
    DataType: u8,
...
test "sizeof ImGuiStackLevelInfo" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiStackLevelInfo) == 72);
}

pub const ImGuiStackTool = extern struct {
...
const ImGuiContextHookCallback = fn (ctx: ?*ImGuiContext, hook: ?*ImGuiContextHook) callconv(.C) void;
pub const ImGuiContextHook = extern struct {
    HookId: c_uint,
    Type: ImGuiContextHookType,
    Owner: c_uint,
    Callback: *const ImGuiContextHookCallback,
    UserData: ?*anyopaque,
};

test "sizeof ImGuiContextHook" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiContextHook) == 32);
}
...
pub const ImGuiContext = extern struct {
    ...
    InputEventsTrail: ImVector,
    Style: ImGuiStyle,
    ConfigFlagsCurrFrame: c_int,
    ConfigFlagsLastFrame: c_int,
    Font: ?*ImFont,
    FontSize: f32,
    FontBaseSize: f32,
    ...
    DebugHookIdInfo: c_uint,
    HoveredId: c_uint,
    HoveredIdPreviousFrame: c_uint,
    ...
    ActiveIdUsingNavDirMask: c_uint,
    ActiveIdUsingNavInputMask: c_uint,
    ActiveIdUsingKeyInputMask: ImBitArrayForNamedKeys,
    CurrentItemFlags: c_int,
    ...
    PlatformLastFocusedViewportId: c_uint,
    FallbackMonitor: ImGuiPlatformMonitor,
    ViewportFrontMostStampCount: c_int,
    NavWindow: ?*ImGuiWindow,
    NavId: c_uint,
    NavFocusScopeId: c_uint,
    NavActivateId: c_uint,
    NavActivateDownId: c_uint,
    NavActivatePressedId: c_uint,
    NavActivateInputId: c_uint,
    NavActivateFlags: c_int,
    NavJustMovedToId: c_uint,
    NavJustMovedToFocusScopeId: c_uint,
    NavJustMovedToKeyMods: c_int,
    NavNextActivateId: c_uint,
    NavNextActivateFlags: c_int,
    ...
    NavInitResultId: c_uint,
    NavInitResultRectRel: ImRect,
    NavMoveSubmitted: bool,
    NavMoveScoringItems: bool,
    NavMoveForwardToNextFrame: bool,
    NavMoveFlags: c_int,
    NavMoveScrollFlags: c_int,
    NavMoveKeyMods: c_int,
    NavMoveDir: c_int,
    NavMoveDirForDebug: c_int,
    NavMoveClipDir: c_int,
    ...
    DragDropSourceFlags: c_int,
    DragDropSourceFrameCount: c_int,
    DragDropMouseButton: c_int,
    DragDropPayload: ImGuiPayload,
    DragDropTargetRect: ImRect,
    DragDropTargetId: c_uint,
    DragDropAcceptFlags: c_int,
    DragDropAcceptIdCurrRectSurface: f32,
    DragDropAcceptIdCurr: c_uint,
    DragDropAcceptIdPrev: c_uint,
    DragDropAcceptFrameCount: c_int,
    DragDropHoldJustPressedId: c_uint,
    DragDropPayloadBufHeap: ImVector,
    ...
    TempInputId: c_uint,
    ColorEditOptions: c_int,
    ColorEditLastHue: f32,
    ColorEditLastSat: f32,
    ColorEditLastColor: c_uint,
    ...
    LogNextPrefix: ?[*:0]const u8,
    LogNextSuffix: ?[*:0]const u8,
    LogLinePosY: f32,
...
pub const ImGuiWindowTempData = extern struct {
    CursorPos: ImVec2,
...
pub const ImGuiWindow = packed struct {
    Name: ?*i8,
    ID: c_uint,
    Flags: c_int,
    FlagsPreviousFrame: c_int,
    WindowClass: ImGuiWindowClass,
    ...
    DockId: c_uint,
    DockTabItemStatusFlags: c_int,
    DockTabItemRect: ImRect,
};

pub const ImGuiTabItem = extern struct {
    ID: c_uint,
    Flags: c_int,
    Window: ?*ImGuiWindow,
    ...
    NameOffset: c_int,
    BeginOrder: c_short,
    IndexDuringLayout: c_short,
    WantClose: bool,
};

test "sizeof ImGuiTabItem" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTabItem) == 56);
}

pub const ImGuiTabBar = extern struct {
    Tabs: ImVector,
    Flags: c_int,
    ID: c_uint,
    SelectedTabId: c_uint,
    NextSelectedTabId: c_uint,
    VisibleTabId: c_uint,
    ...
    ReorderRequestTabId: c_uint,
    ReorderRequestOffset: c_short,
    BeginCount: i8,
    WantLayout: bool,
    VisibleTabWasSubmitted: bool,
    TabsAddedNew: bool,
    TabsActiveCount: c_short,
...
pub const ImGuiTableColumn = packed struct {
    Flags: c_int,
    WidthGiven: f32,
    MinX: f32,
    MaxX: f32,
    ...
    SortDirection: u2,
    SortDirectionsAvailCount: u2,
    SortDirectionsAvailMask: u4,
    SortDirectionsAvailList: u8,
};

test "sizeof ImGuiTableColumn" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTableColumn) == 104);
}

pub const ImGuiTableCellData = extern struct {
    BgColor: c_uint,
    Column: ImGuiTableColumnIdx,
};

test "sizeof ImGuiTableCellData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTableCellData) == 8);
}

pub const ImGuiTableInstanceData = extern struct {
    LastOuterHeight: f32,
    LastFirstRowHeight: f32,
};

test "sizeof ImGuiTableInstanceData" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTableInstanceData) == 8);
}

pub const ImGuiTable = packed struct {
    ID: c_uint,
    Flags: c_int,
    RawData: ?*anyopaque,
    TempData: ?*ImGuiTableTempData,
    Columns: ImSpan,
    DisplayOrderToIndex: ImSpan,
    RowCellData: ImSpan,
    EnabledMaskByDisplayOrder: c_ulonglong,
    EnabledMaskByIndex: c_ulonglong,
    VisibleMaskByIndex: c_ulonglong,
    RequestOutputMaskByIndex: c_ulonglong,
    SettingsLoadedFlags: c_int,
    SettingsOffset: c_int,
    LastFrameActive: c_int,
    ColumnsCount: c_int,
    CurrentRow: c_int,
    CurrentColumn: c_int,
    InstanceCurrent: c_short,
    InstanceInteracted: c_short,
    RowPosY1: f32,
    RowPosY2: f32,
    RowMinHeight: f32,
    RowTextBaseline: f32,
    ...
    RowFlags: u16,
    LastRowFlags: u16,
    RowBgColorCounter: c_int,
    RowBgColor: [2]c_uint,
    BorderColorStrong: c_uint,
    BorderColorLight: c_uint,
    BorderX1: f32,
    BorderX2: f32,
    HostIndentX: f32,
    MinColumnWidth: f32,
    ...
    InstanceDataExtra: ImVector,
    SortSpecsSingle: ImGuiTableColumnSortSpecs,
    SortSpecsMulti: ImVector,
...
pub const ImGuiTableTempData = extern struct {
    TableIndex: c_int,
    LastTimeActive: f32,
...
pub const ImGuiTableColumnSettings = packed struct {
    WidthOrWeight: f32,
    UserID: c_uint,
...
test "sizeof ImGuiTableColumnSettings" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTableColumnSettings) == 12);
}

pub const ImGuiTableSettings = extern struct {
    ID: c_uint,
    SaveFlags: c_int,
    RefScale: f32,
...
test "sizeof ImGuiTableSettings" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImGuiTableSettings) == 16);
}

pub const ImFontBuilderIO = extern struct {
    FontBuilder_Build: ?*const fn (atlas: ?*ImFontAtlas) bool,
};

test "sizeof ImFontBuilderIO" {
    // Optional pointers are the same size as normal pointers, because pointer
    // value 0 is used as the null value.
    try expect(@sizeOf(ImFontBuilderIO) == 8);
}

extern "c" fn _ZN5ImGui14ButtonBehaviorERK6ImRectjPbS3_i(bb: *const ImRect, _id: c_uint, out_hovered: ?*bool, out_held: ?*bool, flags: c_int) bool;
pub fn ButtonBehavior(bb: ImRect, _id: c_uint, out_hovered: ?*bool, out_held: ?*bool, __default: struct{flags: c_int= 0}) bool
{
    return _ZN5ImGui14ButtonBehaviorERK6ImRectjPbS3_i(&bb, _id, out_hovered, out_held, __default.flags);
}
pub const GLFWwindow = opaque {};
pub const GLFWmonitor = opaque {};
extern "c" fn _Z28ImGui_ImplGlfw_InitForOpenGLP10GLFWwindowb(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub fn ImGui_ImplGlfw_InitForOpenGL(window: ?*GLFWwindow, install_callbacks: bool) bool
{
    return _Z28ImGui_ImplGlfw_InitForOpenGLP10GLFWwindowb(window, install_callbacks);
}
extern "c" fn _Z28ImGui_ImplGlfw_InitForVulkanP10GLFWwindowb(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub fn ImGui_ImplGlfw_InitForVulkan(window: ?*GLFWwindow, install_callbacks: bool) bool
{
    return _Z28ImGui_ImplGlfw_InitForVulkanP10GLFWwindowb(window, install_callbacks);
}
extern "c" fn _Z27ImGui_ImplGlfw_InitForOtherP10GLFWwindowb(window: ?*GLFWwindow, install_callbacks: bool) bool;
pub fn ImGui_ImplGlfw_InitForOther(window: ?*GLFWwindow, install_callbacks: bool) bool
{
    return _Z27ImGui_ImplGlfw_InitForOtherP10GLFWwindowb(window, install_callbacks);
}
extern "c" fn _Z23ImGui_ImplGlfw_Shutdownv() void;
pub fn ImGui_ImplGlfw_Shutdown() void
{
    return _Z23ImGui_ImplGlfw_Shutdownv();
}
extern "c" fn _Z23ImGui_ImplGlfw_NewFramev() void;
pub fn ImGui_ImplGlfw_NewFrame() void
{
    return _Z23ImGui_ImplGlfw_NewFramev();
}
extern "c" fn _Z31ImGui_ImplGlfw_InstallCallbacksP10GLFWwindow(window: ?*GLFWwindow) void;
pub fn ImGui_ImplGlfw_InstallCallbacks(window: ?*GLFWwindow) void
{
    return _Z31ImGui_ImplGlfw_InstallCallbacksP10GLFWwindow(window);
}
extern "c" fn _Z31ImGui_ImplGlfw_RestoreCallbacksP10GLFWwindow(window: ?*GLFWwindow) void;
pub fn ImGui_ImplGlfw_RestoreCallbacks(window: ?*GLFWwindow) void
{
    return _Z31ImGui_ImplGlfw_RestoreCallbacksP10GLFWwindow(window);
}
extern "c" fn _Z34ImGui_ImplGlfw_WindowFocusCallbackP10GLFWwindowi(window: ?*GLFWwindow, focused: c_int) void;
pub fn ImGui_ImplGlfw_WindowFocusCallback(window: ?*GLFWwindow, focused: c_int) void
{
    return _Z34ImGui_ImplGlfw_WindowFocusCallbackP10GLFWwindowi(window, focused);
}
extern "c" fn _Z34ImGui_ImplGlfw_CursorEnterCallbackP10GLFWwindowi(window: ?*GLFWwindow, entered: c_int) void;
pub fn ImGui_ImplGlfw_CursorEnterCallback(window: ?*GLFWwindow, entered: c_int) void
{
    return _Z34ImGui_ImplGlfw_CursorEnterCallbackP10GLFWwindowi(window, entered);
}
extern "c" fn _Z32ImGui_ImplGlfw_CursorPosCallbackP10GLFWwindowdd(window: ?*GLFWwindow, x: f64, y: f64) void;
pub fn ImGui_ImplGlfw_CursorPosCallback(window: ?*GLFWwindow, x: f64, y: f64) void
{
    return _Z32ImGui_ImplGlfw_CursorPosCallbackP10GLFWwindowdd(window, x, y);
}
extern "c" fn _Z34ImGui_ImplGlfw_MouseButtonCallbackP10GLFWwindowiii(window: ?*GLFWwindow, button: c_int, action: c_int, mods: c_int) void;
pub fn ImGui_ImplGlfw_MouseButtonCallback(window: ?*GLFWwindow, button: c_int, action: c_int, mods: c_int) void
{
    return _Z34ImGui_ImplGlfw_MouseButtonCallbackP10GLFWwindowiii(window, button, action, mods);
}
extern "c" fn _Z29ImGui_ImplGlfw_ScrollCallbackP10GLFWwindowdd(window: ?*GLFWwindow, xoffset: f64, yoffset: f64) void;
pub fn ImGui_ImplGlfw_ScrollCallback(window: ?*GLFWwindow, xoffset: f64, yoffset: f64) void
{
    return _Z29ImGui_ImplGlfw_ScrollCallbackP10GLFWwindowdd(window, xoffset, yoffset);
}
extern "c" fn _Z26ImGui_ImplGlfw_KeyCallbackP10GLFWwindowiiii(window: ?*GLFWwindow, key: c_int, scancode: c_int, action: c_int, mods: c_int) void;
pub fn ImGui_ImplGlfw_KeyCallback(window: ?*GLFWwindow, key: c_int, scancode: c_int, action: c_int, mods: c_int) void
{
    return _Z26ImGui_ImplGlfw_KeyCallbackP10GLFWwindowiiii(window, key, scancode, action, mods);
}
extern "c" fn _Z27ImGui_ImplGlfw_CharCallbackP10GLFWwindowj(window: ?*GLFWwindow, c: c_uint) void;
pub fn ImGui_ImplGlfw_CharCallback(window: ?*GLFWwindow, c: c_uint) void
{
    return _Z27ImGui_ImplGlfw_CharCallbackP10GLFWwindowj(window, c);
}
extern "c" fn _Z30ImGui_ImplGlfw_MonitorCallbackP11GLFWmonitori(monitor: ?*GLFWmonitor, event: c_int) void;
pub fn ImGui_ImplGlfw_MonitorCallback(monitor: ?*GLFWmonitor, event: c_int) void
{
    return _Z30ImGui_ImplGlfw_MonitorCallbackP11GLFWmonitori(monitor, event);
}
extern "c" fn _Z22ImGui_ImplOpenGL3_InitPKc(glsl_version: ?[*:0]const u8) bool;
pub fn ImGui_ImplOpenGL3_Init(__default: struct{glsl_version: ?[*:0]const u8= null}) bool
{
    return _Z22ImGui_ImplOpenGL3_InitPKc(__default.glsl_version);
}
extern "c" fn _Z26ImGui_ImplOpenGL3_Shutdownv() void;
pub fn ImGui_ImplOpenGL3_Shutdown() void
{
    return _Z26ImGui_ImplOpenGL3_Shutdownv();
}
extern "c" fn _Z26ImGui_ImplOpenGL3_NewFramev() void;
pub fn ImGui_ImplOpenGL3_NewFrame() void
{
    return _Z26ImGui_ImplOpenGL3_NewFramev();
}
extern "c" fn _Z32ImGui_ImplOpenGL3_RenderDrawDataP10ImDrawData(draw_data: ?*ImDrawData) void;
pub fn ImGui_ImplOpenGL3_RenderDrawData(draw_data: ?*ImDrawData) void
{
    return _Z32ImGui_ImplOpenGL3_RenderDrawDataP10ImDrawData(draw_data);
}
extern "c" fn _Z36ImGui_ImplOpenGL3_CreateFontsTexturev() bool;
pub fn ImGui_ImplOpenGL3_CreateFontsTexture() bool
{
    return _Z36ImGui_ImplOpenGL3_CreateFontsTexturev();
}
extern "c" fn _Z37ImGui_ImplOpenGL3_DestroyFontsTexturev() void;
pub fn ImGui_ImplOpenGL3_DestroyFontsTexture() void
{
    return _Z37ImGui_ImplOpenGL3_DestroyFontsTexturev();
}
extern "c" fn _Z37ImGui_ImplOpenGL3_CreateDeviceObjectsv() bool;
pub fn ImGui_ImplOpenGL3_CreateDeviceObjects() bool
{
    return _Z37ImGui_ImplOpenGL3_CreateDeviceObjectsv();
}
extern "c" fn _Z38ImGui_ImplOpenGL3_DestroyDeviceObjectsv() void;
pub fn ImGui_ImplOpenGL3_DestroyDeviceObjects() void
{
    return _Z38ImGui_ImplOpenGL3_DestroyDeviceObjectsv();
}
