...
pub const Vbo = struct {
    ...
    pub fn draw(_: Self, count: u32, __default__: struct { offset: u32 = 0, topology: gl.GLenum = gl.TRIANGLES }) void {
...
pub const Vao = struct {
    ...
    pub fn draw(self: *const Self, count: u32, __default__: struct { offset: u32 = 0, topology: gl.GLenum = gl.TRIANGLES }) void {
        ...
        if (self.ibo) |ibo_| {
            ...
            self.vbo.draw(count, .{ .offset = __default__.offset, .topology = __default__.topology });
        }
    }
};
